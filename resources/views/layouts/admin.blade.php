...
<head>
    ...
    <link href="{{asset('assets/scripts/pe-icon-7-stroke.css')}}" rel="stylesheet"/>
...
{{--                                            {{ __('Logout') }}--}}
  ...
  {{-- main section where victim yield content below...--}}
            <div class="app-main__inner">
            {{--    victim page title--}}
                <div class="app-page-title">
                    <div class="page-title-wrapper">
                  {{--     victim words of the page title--}}
                        <div class="page-title-heading">
                            <div class="page-title-icon">
                                @yield('vic-heading-icon')
                            </div>
                            <div>
                                @yield('heading')
                 ...
                 {{--   victim action still in the title ...--}}
...
{{--                        </div>--}}
            ...
            {{--   here is where victim yields content in the rows--}}
